...
xst -ifn xst.scr
move VGAClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\VGAClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc VGAClock_exdes.ucf VGAClock_exdes

echo 'Running map'
map -timing -pr b VGAClock_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm VGAClock_exdes -w routed.ncd routed.vhd
cd ..
